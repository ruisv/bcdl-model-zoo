# Vendored verbatim from torchreid (deep-person-reid), torchreid/models/osnet_ain.py.
# Upstream: https://github.com/KaiyangZhou/deep-person-reid  (MIT, Kaiyang Zhou).
# Kept in-tree so export/qat/deploy import identical model definitions without a
# torchreid install inside the OpenExplorer container. Unmodified.
